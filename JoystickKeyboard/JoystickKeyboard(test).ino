...
Button btns[] = {
  ...
  { 8, NULL, BTN_TYPE::USER_FUNC1, 0, 0, false, 0, 1, 'r' },             // wiper speed 1
  { 9, NULL, BTN_TYPE::USER_FUNC1, 0, 0, false, 0, 1, 'n' },             // wiper speed 2
  { 1, NULL, BTN_TYPE::USER_FUNC1, 0, 0, false, 0, 1, 'd' },             // wiper speed 3
  { 14, NULL, BTN_TYPE::ACTUAL_PUSH_STATE, 0, 0, false, 0, 1, '1' },     // shift up
  { 15, NULL, BTN_TYPE::ACTUAL_PUSH_STATE, 0, 0, false, 0, 1, '2' },     // shift down
  ...
  { 6, NULL, BTN_TYPE::ACTUAL_PUSH_STATE, 0, 0, false, 0, 1, '3' },      // extra 1 (RX)
  { 10, NULL, BTN_TYPE::ACTUAL_PUSH_STATE, 0, 0, false, 0, 1, '4' },     // extra 2 (TX)
};
